...
const NavItem = ({ href, label }: NavItemProps) => {
    ...
    return (
        <Link href={href}>
            <a className={`p-2 rounded-sm hover:bg-white ${isActive && 'bg-white'}`}>
    ...
    return (
        <>
            <div className="h-full bg-altBg">
                <div className="fixed z-10 flex items-center justify-center w-full bg-white border-b shadow-sm h-11">
                    {/* <div className="flex items-center justify-between w-full max-w-[900px] px-4 py-4 text-xl max-w-screen "> */}
                    <span className="w-[250px] pl-8">Settings</span>
                ...
                <div className="flex flex-col items-stretch min-h-screen md:flex-row md:justify-center">
                    <nav className="flex justify-between px-8 pt-16 pb-4 md:justify-start md:w-64 md:p-8 md:flex-col md:pt-28 bg-altBg">
