...
export type RegisterMutation = { __typename?: 'Mutation' } & {
    register: ({ __typename?: 'BaseError' } & Pick<BaseError, 'message'>) | { __typename?: 'User' };
};
...
export type LoginMutation = { __typename?: 'Mutation' } & {
    login: ({ __typename?: 'BaseError' } & BaseErrorFragment) | ({ __typename: 'User' } & Pick<User, 'id'>);
};
...
export type RequestForgotMutation = { __typename?: 'Mutation' } & Pick<Mutation, 'sendForgotPassword'>;
...
export type CreateBookmarkMutation = { __typename?: 'Mutation' } & {
    createBookmark:
        | ({ __typename?: 'BaseError' } & BaseErrorFragment)
        | ({ __typename?: 'Bookmark' } & BookmarkFragment)
        | ({ __typename?: 'InputValidationError' } & ValidationErrorFragment);
};
...
export type SoftDeleteBookmarkMutation = { __typename?: 'Mutation' } & {
    softDeleteBookmark:
        | ({ __typename?: 'BaseError' } & BaseErrorFragment)
        | ({ __typename?: 'Bookmark' } & BookmarkFragment);
};
...
export type HardDeleteBookmarkMutation = { __typename?: 'Mutation' } & {
    hardDeleteBookmark:
        | ({ __typename?: 'BaseError' } & BaseErrorFragment)
        | ({ __typename?: 'Bookmark' } & BookmarkFragment);
};
...
export type HardDeleteBookmarksMutation = { __typename?: 'Mutation' } & {
    hardDeleteBookmarks:
        | ({ __typename?: 'BaseError' } & BaseErrorFragment)
        | ({ __typename?: 'Bookmarks' } & BookmarksFragment);
};

export type DeletedBookmarksQueryVariables = Exact<{ [key: string]: never }>;

export type DeletedBookmarksQuery = { __typename?: 'Query' } & {
    bookmarks: ({ __typename?: 'BaseError' } & BaseErrorFragment) | ({ __typename?: 'Bookmarks' } & BookmarksFragment);
};
...
export type MoveBookmarkMutation = { __typename?: 'Mutation' } & {
    updateBookmark:
        | { __typename?: 'BaseError' }
        | ({ __typename?: 'Bookmark' } & BookmarkFragment)
        | { __typename?: 'InputValidationError' };
...
export type AllBookmarksQuery = { __typename?: 'Query' } & {
    bookmarks: { __typename?: 'BaseError' } | ({ __typename?: 'Bookmarks' } & BookmarksFragment);
};
...
export type FolderBookmarksQuery = { __typename?: 'Query' } & {
    folder: ({ __typename?: 'BaseError' } & BaseErrorFragment) | ({ __typename?: 'Folder' } & FolderBookmarksFragment);
};
...
export type FolderQuery = { __typename?: 'Query' } & {
    folder: ({ __typename?: 'BaseError' } & BaseErrorFragment) | ({ __typename?: 'Folder' } & FolderFragment);
};
...
export type CreateFolderMutation = { __typename?: 'Mutation' } & {
    createFolder: ({ __typename?: 'BaseError' } & BaseErrorFragment) | ({ __typename?: 'Folder' } & FolderFragment);
};
...
export type DeleteFolderMutation = { __typename?: 'Mutation' } & {
    deleteFolder: ({ __typename?: 'BaseError' } & BaseErrorFragment) | { __typename?: 'Folder' };
};
...
export type MoveFolderMutation = { __typename?: 'Mutation' } & Pick<Mutation, 'changeFolderOrder'> & {
        targetChangeOrder: Mutation['changeFolderOrder'];
    } & { moveFolder: ({ __typename?: 'BaseError' } & BaseErrorFragment) | { __typename?: 'Folder' } };
...
export type ChangeFolderOrderMutation = { __typename?: 'Mutation' } & Pick<Mutation, 'changeFolderOrder'> & {
        targetChangeOrder: Mutation['changeFolderOrder'];
    };
...
export type CreateFolderWithBookmarksMutation = { __typename?: 'Mutation' } & Pick<
    Mutation,
...
export type UpdateFolderMutation = { __typename?: 'Mutation' } & {
    updateFolder: { __typename?: 'BaseError' } | ({ __typename?: 'Folder' } & Pick<Folder, 'id' | 'name'>);
};

export type AllFolderNamesQueryVariables = Exact<{ [key: string]: never }>;

export type AllFolderNamesQuery = { __typename?: 'Query' } & {
    me?: Maybe<
        | { __typename?: 'BaseError' }
        | ({ __typename?: 'User' } & { folders: Array<{ __typename?: 'Folder' } & Pick<Folder, 'id' | 'name'>> })
    >;
};
...
export type GetTreeQuery = { __typename?: 'Query' } & {
    getTree: ({ __typename?: 'BaseError' } & BaseErrorFragment) | ({ __typename?: 'Tree' } & TreeFragment);
};

export type BookmarkFragment = { __typename?: 'Bookmark' } & Pick<
    Bookmark,
    'id' | 'title' | 'url' | 'description' | 'createdDate' | 'folderId'
>;

export type BookmarksFragment = { __typename?: 'Bookmarks' } & {
    bookmarks: Array<
        Maybe<
...
export type TreeFragment = { __typename?: 'Tree' } & Pick<Tree, 'tree'>;

export type FoldersArrayFragment = { __typename?: 'Folders' } & {
    folders: Array<Maybe<{ __typename?: 'Folder' } & Pick<Folder, 'id'>>>;
};

export type FolderFragment = { __typename?: 'Folder' } & Pick<Folder, 'id' | 'name' | 'isOpen'> & {
        children: Array<Maybe<{ __typename?: 'Folder' } & Pick<Folder, 'id' | 'name'>>>;
        bookmarks: Array<Maybe<{ __typename?: 'Bookmark' } & BookmarkFragment>>;
    };

export type FolderBookmarksFragment = { __typename?: 'Folder' } & {
    bookmarks: Array<Maybe<{ __typename?: 'Bookmark' } & BookmarkFragment>>;
};

export type BaseErrorFragment = { __typename?: 'BaseError' } & Pick<BaseError, 'path' | 'message'>;

export type ValidationErrorFragment = { __typename?: 'InputValidationError' } & Pick<InputValidationError, 'path'> & {
        errors: Array<Maybe<{ __typename?: 'BaseError' } & Pick<BaseError, 'message' | 'path'>>>;
    };

export type UserNameQueryVariables = Exact<{ [key: string]: never }>;

export type UserNameQuery = { __typename?: 'Query' } & {
    me?: Maybe<{ __typename?: 'BaseError' } | ({ __typename?: 'User' } & Pick<User, 'id' | 'name'>)>;
};
...
export type ResolversTypes = ResolversObject<{
    ...
    BookmarkResultWithInput:
        | ResolversTypes['BaseError']
        | ResolversTypes['Bookmark']
        | ResolversTypes['InputValidationError'];
    Bookmarks: ResolverTypeWrapper<
        Omit<Bookmarks, 'bookmarks'> & { bookmarks: Array<Maybe<ResolversTypes['Bookmark']>> }
    >;
...
export type ResolversParentTypes = ResolversObject<{
    ...
    BookmarkResultWithInput:
        | ResolversParentTypes['BaseError']
        | ResolversParentTypes['Bookmark']
        | ResolversParentTypes['InputValidationError'];
...
export type AuthDirectiveResolver<Result, Parent, ContextType = MyContext, Args = AuthDirectiveArgs> =
...
export type BookmarkResultResolvers<
    ContextType = MyContext,
    ParentType extends ResolversParentTypes['BookmarkResult'] = ResolversParentTypes['BookmarkResult'],
> = ResolversObject<{
    __resolveType: TypeResolveFn<'BaseError' | 'Bookmark', ParentType, ContextType>;
}>;

export type BookmarkResultWithInputResolvers<
    ContextType = MyContext,
    ParentType extends ResolversParentTypes['BookmarkResultWithInput'] = ResolversParentTypes['BookmarkResultWithInput'],
> = ResolversObject<{
    __resolveType: TypeResolveFn<'BaseError' | 'Bookmark' | 'InputValidationError', ParentType, ContextType>;
}>;

export type BookmarksResolvers<
    ContextType = MyContext,
    ParentType extends ResolversParentTypes['Bookmarks'] = ResolversParentTypes['Bookmarks'],
> = ResolversObject<{
    bookmarks?: Resolver<Array<Maybe<ResolversTypes['Bookmark']>>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type BookmarksResultResolvers<
    ContextType = MyContext,
    ParentType extends ResolversParentTypes['BookmarksResult'] = ResolversParentTypes['BookmarksResult'],
> = ResolversObject<{
    __resolveType: TypeResolveFn<'BaseError' | 'Bookmarks', ParentType, ContextType>;
}>;

export type BooleanOrErrorResolvers<
    ContextType = MyContext,
    ParentType extends ResolversParentTypes['BooleanOrError'] = ResolversParentTypes['BooleanOrError'],
> = ResolversObject<{
...
export type FolderArrayResultResolvers<
    ContextType = MyContext,
    ParentType extends ResolversParentTypes['FolderArrayResult'] = ResolversParentTypes['FolderArrayResult'],
> = ResolversObject<{
    __resolveType: TypeResolveFn<'BaseError' | 'Folders', ParentType, ContextType>;
}>;

export type FolderResultResolvers<
    ContextType = MyContext,
    ParentType extends ResolversParentTypes['FolderResult'] = ResolversParentTypes['FolderResult'],
> = ResolversObject<{
    __resolveType: TypeResolveFn<'BaseError' | 'Folder', ParentType, ContextType>;
}>;

export type FoldersResolvers<
    ContextType = MyContext,
    ParentType extends ResolversParentTypes['Folders'] = ResolversParentTypes['Folders'],
> = ResolversObject<{
    folders?: Resolver<Array<Maybe<ResolversTypes['Folder']>>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type InputValidationErrorResolvers<
    ContextType = MyContext,
    ParentType extends ResolversParentTypes['InputValidationError'] = ResolversParentTypes['InputValidationError'],
> = ResolversObject<{
    path?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
> = ResolversObject<{
    changeFolderOrder?: Resolver<
        ResolversTypes['Boolean'],
        ParentType,
        ContextType,
        RequireFields<MutationChangeFolderOrderArgs, 'id' | 'order'>
    >;
    createBookmark?: Resolver<
        ResolversTypes['BookmarkResultWithInput'],
        ParentType,
        ContextType,
        RequireFields<MutationCreateBookmarkArgs, 'data'>
    >;
    createFolder?: Resolver<
        ResolversTypes['FolderResult'],
        ParentType,
        ContextType,
        RequireFields<MutationCreateFolderArgs, 'data'>
    >;
    createFolderWithBookmarks?: Resolver<
        Maybe<ResolversTypes['Boolean']>,
        ParentType,
        ContextType,
        RequireFields<MutationCreateFolderWithBookmarksArgs, 'data'>
    >;
    ...
    >;
    hardDeleteBookmark?: Resolver<
        ResolversTypes['BookmarkResult'],
        ParentType,
        ContextType,
        RequireFields<MutationHardDeleteBookmarkArgs, 'id'>
    >;
    hardDeleteBookmarks?: Resolver<
        ResolversTypes['BookmarksResult'],
        ParentType,
        ContextType,
        RequireFields<MutationHardDeleteBookmarksArgs, 'ids'>
    >;
    ...
    moveFolder?: Resolver<
        ...
        ParentType,
        ContextType,
        RequireFields<MutationMoveFolderArgs, 'folderId'>
    >;
    recoverFolder?: Resolver<
        ResolversTypes['FolderResult'],
        ParentType,
        ContextType,
        RequireFields<MutationRecoverFolderArgs, 'id'>
    >;
    register?: Resolver<
        ResolversTypes['UserResult'],
        ParentType,
    ...
    resetPassword?: Resolver<
        ResolversTypes['BooleanOrError'],
        ParentType,
        ContextType,
        RequireFields<MutationResetPasswordArgs, 'email' | 'password' | 'resetToken'>
    >;
    sendForgotPassword?: Resolver<
        ResolversTypes['Boolean'],
        ParentType,
        ContextType,
        RequireFields<MutationSendForgotPasswordArgs, 'email'>
    >;
    softDeleteBookmark?: Resolver<
        ResolversTypes['BookmarkResult'],
        ParentType,
        ContextType,
        RequireFields<MutationSoftDeleteBookmarkArgs, 'id'>
    >;
    softDeleteBookmarks?: Resolver<
        ResolversTypes['BookmarksResult'],
        ParentType,
        ContextType,
        RequireFields<MutationSoftDeleteBookmarksArgs, 'ids'>
    >;
    softDeleteFolder?: Resolver<
        ResolversTypes['FolderResult'],
        ParentType,
        ContextType,
        RequireFields<MutationSoftDeleteFolderArgs, 'id'>
    >;
    updateBookmark?: Resolver<
        ResolversTypes['BookmarkResultWithInput'],
        ParentType,
        ContextType,
        RequireFields<MutationUpdateBookmarkArgs, 'data'>
    >;
    updateFolder?: Resolver<
        ResolversTypes['FolderResult'],
        ParentType,
        ContextType,
        RequireFields<MutationUpdateFolderArgs, 'data'>
    >;
    updateFolderName?: Resolver<
        ResolversTypes['FolderResult'],
        ParentType,
        ContextType,
        RequireFields<MutationUpdateFolderNameArgs, 'id' | 'name'>
    >;
}>;
...
export type TreeResultResolvers<
    ContextType = MyContext,
    ParentType extends ResolversParentTypes['TreeResult'] = ResolversParentTypes['TreeResult'],
> = ResolversObject<{
 ...
 * });
 */
export function useRequestForgotMutation(
    baseOptions?: Apollo.MutationHookOptions<RequestForgotMutation, RequestForgotMutationVariables>,
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export type RequestForgotMutationOptions = Apollo.BaseMutationOptions<
    RequestForgotMutation,
    RequestForgotMutationVariables
>;
...
export const SoftDeleteBookmarkDocument = gql`
    ...
    ${BaseErrorFragmentDoc}
`;
export type SoftDeleteBookmarkMutationFn = Apollo.MutationFunction<
    SoftDeleteBookmarkMutation,
    SoftDeleteBookmarkMutationVariables
>;
 ...
 * });
 */
export function useSoftDeleteBookmarkMutation(
    baseOptions?: Apollo.MutationHookOptions<SoftDeleteBookmarkMutation, SoftDeleteBookmarkMutationVariables>,
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useMutation<SoftDeleteBookmarkMutation, SoftDeleteBookmarkMutationVariables>(
        SoftDeleteBookmarkDocument,
        options,
    );
}
...
export type SoftDeleteBookmarkMutationOptions = Apollo.BaseMutationOptions<
    SoftDeleteBookmarkMutation,
    SoftDeleteBookmarkMutationVariables
>;
export const HardDeleteBookmarkDocument = gql`
    ...
    ${BaseErrorFragmentDoc}
`;
export type HardDeleteBookmarkMutationFn = Apollo.MutationFunction<
    HardDeleteBookmarkMutation,
    HardDeleteBookmarkMutationVariables
>;
 ...
 * });
 */
export function useHardDeleteBookmarkMutation(
    baseOptions?: Apollo.MutationHookOptions<HardDeleteBookmarkMutation, HardDeleteBookmarkMutationVariables>,
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useMutation<HardDeleteBookmarkMutation, HardDeleteBookmarkMutationVariables>(
        HardDeleteBookmarkDocument,
        options,
    );
}
...
export type HardDeleteBookmarkMutationOptions = Apollo.BaseMutationOptions<
    HardDeleteBookmarkMutation,
    HardDeleteBookmarkMutationVariables
>;
export const HardDeleteBookmarksDocument = gql`
    ...
    ${BaseErrorFragmentDoc}
`;
export type HardDeleteBookmarksMutationFn = Apollo.MutationFunction<
    HardDeleteBookmarksMutation,
    HardDeleteBookmarksMutationVariables
>;
 ...
 * });
 */
export function useHardDeleteBookmarksMutation(
    baseOptions?: Apollo.MutationHookOptions<HardDeleteBookmarksMutation, HardDeleteBookmarksMutationVariables>,
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useMutation<HardDeleteBookmarksMutation, HardDeleteBookmarksMutationVariables>(
        HardDeleteBookmarksDocument,
        options,
    );
}
...
export type HardDeleteBookmarksMutationOptions = Apollo.BaseMutationOptions<
    HardDeleteBookmarksMutation,
    HardDeleteBookmarksMutationVariables
>;
 ...
 * });
 */
export function useDeletedBookmarksQuery(
    baseOptions?: Apollo.QueryHookOptions<DeletedBookmarksQuery, DeletedBookmarksQueryVariables>,
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useQuery<DeletedBookmarksQuery, DeletedBookmarksQueryVariables>(DeletedBookmarksDocument, options);
}
export function useDeletedBookmarksLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<DeletedBookmarksQuery, DeletedBookmarksQueryVariables>,
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useLazyQuery<DeletedBookmarksQuery, DeletedBookmarksQueryVariables>(
        DeletedBookmarksDocument,
        options,
    );
}
...
export function useMoveBookmarkMutation(
    baseOptions?: Apollo.MutationHookOptions<MoveBookmarkMutation, MoveBookmarkMutationVariables>,
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export type MoveBookmarkMutationOptions = Apollo.BaseMutationOptions<
    MoveBookmarkMutation,
    MoveBookmarkMutationVariables
>;
...
export function useAllBookmarksQuery(
    baseOptions?: Apollo.QueryHookOptions<AllBookmarksQuery, AllBookmarksQueryVariables>,
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useAllBookmarksLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<AllBookmarksQuery, AllBookmarksQueryVariables>,
) {
    const options = { ...defaultOptions, ...baseOptions };
 ...
 * });
 */
export function useFolderBookmarksQuery(
    baseOptions: Apollo.QueryHookOptions<FolderBookmarksQuery, FolderBookmarksQueryVariables>,
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useQuery<FolderBookmarksQuery, FolderBookmarksQueryVariables>(FolderBookmarksDocument, options);
}
export function useFolderBookmarksLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<FolderBookmarksQuery, FolderBookmarksQueryVariables>,
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useMoveFolderMutation(
    baseOptions?: Apollo.MutationHookOptions<MoveFolderMutation, MoveFolderMutationVariables>,
) {
    const options = { ...defaultOptions, ...baseOptions };
...
`;
export type ChangeFolderOrderMutationFn = Apollo.MutationFunction<
    ChangeFolderOrderMutation,
    ChangeFolderOrderMutationVariables
>;
 ...
 * });
 */
export function useChangeFolderOrderMutation(
    baseOptions?: Apollo.MutationHookOptions<ChangeFolderOrderMutation, ChangeFolderOrderMutationVariables>,
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useMutation<ChangeFolderOrderMutation, ChangeFolderOrderMutationVariables>(
        ChangeFolderOrderDocument,
        options,
    );
}
...
export type ChangeFolderOrderMutationOptions = Apollo.BaseMutationOptions<
    ChangeFolderOrderMutation,
    ChangeFolderOrderMutationVariables
>;
...
`;
export type CreateFolderWithBookmarksMutationFn = Apollo.MutationFunction<
    CreateFolderWithBookmarksMutation,
    CreateFolderWithBookmarksMutationVariables
>;
 ...
 * });
 */
export function useCreateFolderWithBookmarksMutation(
    ...
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useMutation<CreateFolderWithBookmarksMutation, CreateFolderWithBookmarksMutationVariables>(
        CreateFolderWithBookmarksDocument,
        options,
    );
}
...
export type CreateFolderWithBookmarksMutationOptions = Apollo.BaseMutationOptions<
    CreateFolderWithBookmarksMutation,
    CreateFolderWithBookmarksMutationVariables
>;
 ...
 * });
 */
export function useAllFolderNamesQuery(
    baseOptions?: Apollo.QueryHookOptions<AllFolderNamesQuery, AllFolderNamesQueryVariables>,
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useQuery<AllFolderNamesQuery, AllFolderNamesQueryVariables>(AllFolderNamesDocument, options);
}
export function useAllFolderNamesLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<AllFolderNamesQuery, AllFolderNamesQueryVariables>,
) {
    const options = { ...defaultOptions, ...baseOptions };
...
const result: PossibleTypesResultData = {
    possibleTypes: {
        BookmarkResult: ['BaseError', 'Bookmark'],
        BookmarkResultWithInput: ['BaseError', 'Bookmark', 'InputValidationError'],
        BookmarksResult: ['BaseError', 'Bookmarks'],
        BooleanOrError: ['BaseError', 'Success'],
        FolderArrayResult: ['BaseError', 'Folders'],
        FolderResult: ['BaseError', 'Folder'],
        TreeResult: ['BaseError', 'Tree'],
        UserResult: ['BaseError', 'User'],
    },
};
